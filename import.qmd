...
readr::read_delim("data/blood_fat.csv", show_col_types = FALSE, col_types = cols(age = "i",id = "i"))
...
readr::read_delim("data/blood_fat.csv", show_col_types = FALSE, col_types = cols(age = "i",id = "i", weight = "_"))
